...
// 1: Seneca the Younger was a Roman philosopher. He is known for his philosophies and plays
// 2: He is commonly associated with the Stoicism school of philosophy
// 3: The Stoicism school of philosphy draws from the teachings from Heraclitus and Socrates and
// it largely focuses on personal ethics within the natural world as well as moral virtues.
...
//
val fizzbuzz = (1..15).map {
    it ->
        var result = ""
        if (it % 15 == 0) result += "FIZZBUZZ"
    	else if (it % 3 == 0) result += "FIZZ"
    	else if (it % 5 == 0) result += "BUZZ"
    	result
}

val mapFoldResults = fizzbuzz.fold("", { element, nextElement -> element + nextElement })
